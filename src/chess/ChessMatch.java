...
public class ChessMatch {
    ...
    private ChessPiece enPanssantVulnerable;
    ...
    public ChessPiece getEnPanssantVulnerable(){
        return enPanssantVulnerable;
    }
    ...
    public ChessPiece perfomChessMove(ChessPosition sourcePosition, ChessPosition targetPosition){
        ...
        if(movedPiece instanceof Pawn && (target.getRow() == source.getRow() - 2 || target.getRow() == source.getRow() + 2)) {
            enPanssantVulnerable = movedPiece;
        }else{
            enPanssantVulnerable = null;
        }
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece){
        ...
        // #specialmove en passant
        if(p instanceof Pawn){
            if(source.getColumn() != target.getColumn() && capturedPiece == enPanssantVulnerable ){
